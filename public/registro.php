...
<head>
  ...
  <style>
    ...
    * {
    ...
    .registro__container {
      width: 100%;
      max-width: 700px; /* Aumenté el ancho para 2 columnas */
      perspective: 1000px;
    }
    ...
    .formulario__submit:hover::before {
      left: 100%;
    }
      ...
      <div class="registro__subcontainer" id="registerBox">
        ...
        <form action="/pruebas/app/controllers/usuarioController.php?action=register" method="post" class="registro__formulario">
          ...
          <div class="formulario__group formulario__group--full">
            ...
            <input type="password" name="contrasena" id="contrasena" class="formulario__input"/>
          </div>
