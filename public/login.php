...
<body>
  ...
  <main class="login__main">
    ...
    <div class="login__container">
      <div class="login__subcontainer" id="loginBox">
        ...
        <form action="/pruebas/app/controllers/usuarioController.php?action=login" class="login__formulario" method="post">
          <label for="usuario" class="formulario__label">Usuario</label>
          <input type="text" class="login__input input--usuario" name="usuario" placeholder="Ingrese su usuario">

          <label for="contrasenia" class="formulario__label">Contraseña</label>
          <input type="password" class="login__input input--contrasenia" name="contrasenia" placeholder="Ingrese su contraseña">
  ...
  <script>
    ...
    // efecto de paralaje mejorado (sin pisar la animación inicial)
